...
reading the image name, magnification, X- and Y-axis scales and unit
string. If the unit string is in nm, it converts to microns. It opens
the image, calibrates the scale and saves the image.
...
2016-02-01  JRM 0.1.20  Add mag to comment in Info field. Rename.
2017-04-12  JRM 0.1.21  PEP8 and move codec to top
...
for name in names:
    ...
    sMag = "Mag: %.1f X, " % fMag
    newInfo  = "Microscope: " + sMicroscope 
    newInfo += " Software: AnalySIS.0, User: " + sUser +  "\n" 
    newInfo +=  sMag + sComment
