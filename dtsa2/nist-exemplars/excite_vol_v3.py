...
for z in zrange:
    ...
    for e0 in erange:
       ...
       # Create a simulator and initialize it
        ...
        if version==3:
        	xrel=nm.CharacteristicXRayGeneration.create(monte)
        	nm.XRayTransport.create(monte,det,xrel)
        else:
        ...
        if version==3:
            addListener=xrel.addXRayListener
        else:
            addListener=xrel.addActionListener
        addListener(xra)
