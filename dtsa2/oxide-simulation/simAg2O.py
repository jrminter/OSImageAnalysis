...
rel="/work/proj/QM13-02-05D-Irving/dat/dtsa-sim/"
base=home+rel
...
ago=epq.Material(epq.Composition([epq.Element.Ag, epq.Element.O],
[0.930958,0.069042]), epq.ToSI.gPerCC(7.14))
...
monte.addSubRegion(monte.getChamber(),ago,lay)
...
"%g nm Ag2O film on 50 nm C substrate" % nmThick)
...
fos=jio.FileOutputStream("%s/Ag2O%gnm-on-50nm-C.msa" % (base, nmThick))
