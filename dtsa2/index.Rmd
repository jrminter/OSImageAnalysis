...
2. Restart DTSA
3. Add my instruments and detectors ***in this order
   with these names:***
   ...
   - ``NIST JXA8500F`` (5-30kV) importing 
      ``3-NIST JXA8500F Brucker-SDD.xdet``. We
      add this detecor to be able to work the
      DTSA examples.
      
   Note that one needs to start an edit after the
   ``Add`` instrument button is pressed before changing
   to another window to copy. Otherwise, the edit
   box is non-responsive.
